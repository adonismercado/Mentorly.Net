...
public sealed class AcademicContentTests
{
    ...
    public void Hierarchy_Constructors_CreateValidContent()
    {
        ...
        var activity = new Activity(Guid.NewGuid(), theme.Id, "Exercise", "Activity Description", ActivityType.Exercise, true, ApprovalStrategy.PeerReview, 1);
    ...
    {
        var action = () => new Activity(Guid.NewGuid(), Guid.NewGuid(), "Quiz", "Quiz Description", ActivityType.Quiz, true, ApprovalStrategy.PeerReview, 1);
